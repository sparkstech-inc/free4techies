// AboutPage — what Free4Techies is, how it works. B/W theme.
    ...
    <Layout>
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-3 text-lg text-ink-600 dark:text-ink-400">
          A modern, searchable, community-driven list of free developer
          tools, services and tiers — built to be better than free-for.dev.
        </p>

        <div className="prose mt-8 max-w-none text-ink-700 dark:text-ink-300">
          <p>
            ...
            <code>resources.json</code> on GitHub.
          </p>
          ...
          <p>
            ...
            committed to the{' '}
            <a href={config.repoUrl} target="_blank" rel="noreferrer">GitHub repo</a>.
            The website is a pure static React app — there is no server.
            The browser fetches <code>resources.json</code> directly and renders
            a scannable, markdown-style list with a table of contents, just like
            free-for.dev's README but with instant search and filters.
          </p>
          <p>
            To submit a new resource, use the{' '}
            <Link to="/submit">submit form</Link>. No login is required on this
            site. The form validates your entry and generates a pre-filled
            GitHub issue. When you post that issue, a GitHub Action parses the
            submission, validates it against the schema, checks for duplicates,
            writes the updated <code>resources.json</code> to a new branch,
            opens a pull request, and <strong>auto-merges</strong> it if
            everything is valid. If validation fails, the bot comments on the
            issue with the exact errors so you can fix and resubmit.
          </p>
          <p>
          ...
          <ul>
            <li><strong>Markdown-style list</strong> — resources are shown as a scannable bulleted list with a table of contents, not a card grid that's hard to navigate at scale.</li>
            ...
            <li><strong>Structured data</strong> — resources live in a typed JSON file, not a giant markdown list you have to edit by hand.</li>
            ...
            <li><strong>Black & white theme</strong> — clean, minimal, distraction-free. Dark mode included.</li>
            <li><strong>Responsive</strong> — works great on phones, tablets and desktops.</li>
          </ul>

          <h2>Submitting rules</h2>
          <ul>
          ...
          <p>
            ...
            consider <Link to="/sponsor">becoming a sponsor</Link>,
